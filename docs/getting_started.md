...
3. Refer to the [Server Documentation](imported/server/index.md) for environment setup, deployment, and service configuration.
4. Use the [Client Documentation](imported/client/index.md) for local installation, API guidelines, and experiment execution.
---
...
### 4. First Run
1. Start the [FIREQ-Server](imported/server/index.md) process on the board.
```bash
python API.py
```
2. Launch the [FIREQ-Client](imported/client/index.md) on your host PC:
```bash
python run_client.py
```
3. run an [experiment](imported/client/usage.md) with `run_yaml experiments/Rabi.yaml`,
